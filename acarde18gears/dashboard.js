...
Funbit.Ets.Telemetry.Dashboard.prototype.render = function (data, utils) {
	...
	if(data.truck.displayedGear === 11){
		$('._gear11').height(421);
	}
	if(data.truck.displayedGear === 12){
		$('._gear12').height(421);
	}
	if(data.truck.displayedGear === 13){
		$('._gear13').height(421);
	}
	if(data.truck.displayedGear === 14){
		$('._gear14').height(421);
	}
	if(data.truck.displayedGear === 15){
		$('._gear15').height(421);
	}
	if(data.truck.displayedGear === 16){
		$('._gear16').height(421);
	}
	if(data.truck.displayedGear === 17){
		$('._gear17').height(421);
	}
	if(data.truck.displayedGear === 18){
		$('._gear18').height(421);
	}
	//
